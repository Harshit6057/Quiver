...
const LandingPage = () => {
  return (
    <div className="relative pt-8 sm:pt-12 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen overflow-x-hidden">
      ...
      <section className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center min-h-0 lg:min-h-[716px]">
        <div className="space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-black font-space-grotesk tracking-tighter leading-[0.95] text-on-background break-words">
            Beyond the <br/>
          ...
          <p className="text-base sm:text-lg lg:text-xl text-on-surface-variant max-w-lg leading-relaxed font-body">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <Link to="/" className="bg-gradient-to-r from-primary to-primary-container text-on-primary font-bold px-6 sm:px-10 py-4 rounded-xl active:scale-95 duration-200 transition-all text-sm sm:text-lg shadow-[0_0_40px_rgba(183,109,255,0.2)]">
              Join the Network
            </Link>
            <Link to="/explore" className="bg-surface-container-highest/40 backdrop-blur-md text-white border border-white/10 font-bold px-6 sm:px-10 py-4 rounded-xl hover:bg-white/10 transition-all active:scale-95 duration-200 text-sm sm:text-lg">
              Explore Vault
            </Link>
          </div>
        </div>
        ...
        {/* Bento Preview */}
        <div className="grid grid-cols-2 sm:grid-cols-6 grid-rows-4 sm:grid-rows-6 gap-3 sm:gap-4 h-auto sm:h-[600px]">
          <div className="col-span-2 sm:col-span-4 row-span-2 sm:row-span-4 rounded-xl overflow-hidden relative group min-h-[240px] sm:min-h-0">
          ...
          <div className="col-span-1 sm:col-span-2 row-span-1 sm:row-span-2 bg-surface-container-highest/40 backdrop-blur-xl rounded-xl border border-white/5 flex flex-col items-center justify-center p-4 sm:p-6 text-center min-h-[120px] sm:min-h-0">
            <span className="material-symbols-outlined text-secondary text-4xl mb-2">trending_up</span>
            <span className="text-2xl sm:text-3xl font-black font-space-grotesk text-white">4.2%</span>
            <span className="text-[10px] text-slate-400 uppercase tracking-widest">Network Growth</span>
          </div>
          <div className="col-span-1 sm:col-span-2 row-span-2 sm:row-span-4 rounded-xl overflow-hidden relative min-h-[240px] sm:min-h-0">
          ...
          <div className="col-span-2 sm:col-span-4 row-span-1 sm:row-span-2 bg-surface-container-low rounded-xl border border-white/5 p-4 sm:p-6 flex justify-between items-end">
